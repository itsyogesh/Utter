package com.droidsize.utter.fragments;
...
import com.droidsize.utter.ViewImageActivity;
import com.droidsize.utter.utils.MessageAdapter;
    ...
    public void onResume(){
        ...
        query.findInBackground(new FindCallback<ParseObject>() {
            ...
            public void done(List<ParseObject> messages, ParseException e) {
                ...
                if(e != null){
                    Crouton.makeText(getActivity(), "Error connecting to internet",
                            Style.INFO).show();
                }
