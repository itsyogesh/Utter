...
import com.droidsize.utter.utils.SectionsPagerAdapter;
                ...
                case 0: {
                    ...
                    if(mMediaUri == null){
                        ...
                        Crouton.makeText(MainActivity.this,
                                R.string.error_external_storage, Style.INFO).show();
                    }
                    else {
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data){
        ...
        if(resultCode == RESULT_OK){
            if(requestCode == PICK_PHOTO_REQUEST || requestCode == PICK_VIDEO_REQUEST){
                if(data == null){
                    Crouton.makeText(this, R.string.general_error, Style.ALERT).show();
                }
                else{
                ...
                if(requestCode == PICK_VIDEO_REQUEST){
                    ...
                    if (fileSize >= FILE_SIZE_LIMIT){
                        Crouton.makeText(this, "The Selected file is too large.", Style.ALERT).show();
                        return;
                    }
                }
            }
